...
namespace Tangy_Business.Repository
{
    public class OrderRepository : IOrderRepository
    {
        ...
        public async Task<IEnumerable<OrderDTO>> GetAll(string? userId = null, string? status = null)
        {
            ...
            IEnumerable<OrderDetail> orderDetaiList = _db.OrderDetails!;
            ...
            foreach (OrderHeader header in orderHeaderList)
            {
                ...
                {
                    OrderHeader = header,
                    OrderDetails = orderDetaiList.Where(u => u.OrderHeaderId == header.Id)
                };
        ...
        public async Task<OrderHeaderDTO> UpdateHeader(OrderHeaderDTO objDTO)
        {
            if (objDTO != null)
            {
                OrderHeader orderHeaderFromDb = await _db.OrderHeaders.FirstOrDefaultAsync(u => u.Id == objDTO.Id);
